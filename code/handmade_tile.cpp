...
inline void
SetTileValue(tile_map *TileMap, tile_chunk *TileChunk, uint32 TestX, uint32 TestY, uint32 TileValue)
{
    uint32 TileChunkValue = 0;
...
{
    uint32 TileChunkValue = GetTileValue(TileMap, TileMapPos.AbsTileX, TileMapPos.AbsTileY);
